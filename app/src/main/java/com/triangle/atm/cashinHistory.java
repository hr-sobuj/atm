...
public class cashinHistory extends AppCompatActivity {
    ...
    private firebase_adapter2 firebaseAdapter;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_cashin_history);
        ...
        reference_cashout= FirebaseDatabase.getInstance().getReference("ATM").child(user_identity).child("Cashin_History");

        firebasess=new ArrayList<>();

        firebaseAdapter=new firebase_adapter2(cashinHistory.this,firebasess);
        ...
        reference_cashout.orderByKey().addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if(dataSnapshot.exists()){
                    ...
                    progressDialog.dismiss();
                    Toast.makeText(cashinHistory.this,"Data not found :(",Toast.LENGTH_LONG).show();
                    Intent intent=new Intent(cashinHistory.this,MainActivity.class);
