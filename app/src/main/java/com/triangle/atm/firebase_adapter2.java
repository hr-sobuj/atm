...
public class firebase_adapter2 extends ArrayAdapter<db_cashout> {

    private Activity context;
    private List<db_cashout> databaseView;


    public firebase_adapter2(Activity context, List<db_cashout> databaseView) {
        super(context, R.layout.firebase_data_show_layout2, databaseView);
    ...
    public View getView(int position,View convertView,ViewGroup parent) {
        ...
        View vieww=layoutInflater.inflate(R.layout.firebase_data_show_layout2,null,false);
